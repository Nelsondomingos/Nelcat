...
if (
  informationConsult == "" ||
  informationConsult == null ||
  informationConsult == undefined
) {
  ...
  let name = (document.querySelector("#name").innerHTML =
    informationConsult[0].name);
  email = document.querySelector("#email").innerHTML =
    informationConsult[0].email;
  typeConsult = document.querySelector("#consulta").innerHTML =
    informationConsult[0].type;
